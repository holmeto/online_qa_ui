  ...
  <div>
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" size="medium">
        <el-dialog
          ...
          <el-form-item label="标题" prop="userName" style="width: 50%">
            <el-input v-model="ruleForm.userName"></el-input>
          </el-form-item>
          <el-form-item label="问题描述" prop="userAddress">
            <el-input type="textarea" rows="10" v-model="ruleForm.userAddress"></el-input>
          </el-form-item>
